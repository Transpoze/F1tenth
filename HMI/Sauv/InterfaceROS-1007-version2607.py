...
class Game:
    ...
    def CreatePersonalizedScenario(self):
        ...
        'The click must be on the map : x > 500'
                ...
                if event.type == MOUSEBUTTONDOWN and event.button == 1 :
                    ...
                    if x > 500 :
                        ...
                        if len(Tableau2)>0:
                            ...
                            Tableau3.extend([[x, y]])
                            pygame.draw.circle(self.screen, GREEN, (x,y), 5, 0)
                            P=[x,y]
                    	Tableau2.extend([P])
                    	pygame.display.update()
    ...
    def infinite_loop(self):
        ...
        while self.loop :
            ...
            for event in pygame.event.get():
                ...
                if event.type == MOUSEBUTTONDOWN and event.button == 1 and event.pos[0] > 500 and event.pos[1] < 436 and self.map1 == 'KTHMap' and self.map1 != 'KTHE' :
                        self.zoom = 2
                        self.map1 = 'KTHW'
                ...
                if event.type == MOUSEBUTTONDOWN and event.button == 1 and event.pos[0] > 500 and event.pos[1] > 436 and self.map1 == 'KTHMap'and self.map1 != 'KTHW' :
                    self.zoom = 2
                ...
                if event.type == MOUSEBUTTONDOWN and event.button == 1 and event.pos[0] > 500 :
                    x_mouse, y_mouse = pygame.mouse.get_pos()[0] - 500, pygame.mouse.get_pos()[1]
                    #selon que lon est en zoom ou non, conversion inverse pour stockage et envoie a Linus
                    #stockage dans une liste L
