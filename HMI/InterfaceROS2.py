        ...
        while self.loop:
            ...
            if xS_KTH!=None and yS_KTH!=None and state_x!=None and state_y!=None and xS_Kista!=None and yS_Kista!=None  :
            	...
            	if x_Kista<1227 and x_Kista>911 and y_Kista>305 and y_Kista<725:
            		x_KisaS,y_KistaS=int(a2*x_Kista+b2), int(c2*y_Kista+d2)
            ...
            for event in pygame.event.get():
                ...
                if event.type==pygame.MOUSEBUTTONDOWN and event.button==3 and event.pos[0]>500:
                    	...
                    	if self.map=='KTHS' or self.map=='KTHN':
                    		...
                    		print('xS_KTH', xS_KTH, 'yS_KTH', yS_KTH)

                    		if xS_KTH!=None and yS_KTH!=None and state_x!=None and state_y!=None :
            					pygame.draw.circle(self.screen, ORANGE, ( xS_KTH, yS_KTH), 5, 0)
            					self.position_perso.centerx=x_KTH
            					self.position_perso.centery=y_KTH
            					print(self.position_perso.centerx, self.position_perso.centery)

                    		if Click==True: #On peut l'enlever ?
                    		...
                    		if xS_Kista!=None and yS_Kista!=None and state_x!=None and state_y!=None :
            					pygame.draw.circle(self.screen, ORANGE, ( xS_Kista, yS_Kista), 5, 0)
            					self.position_perso.centerx=x_Kista
            					self.position_perso.centery=y_Kista
            					print(self.position_perso.centerx, self.position_perso.centery)
                ...
                if event.type==MOUSEBUTTONDOWN and event.button==1 and event.pos[0]>500 and event.pos[1]<436:
                	...
                	if self.map=='KistaMap' or self.map=='KistaS':
            			...
            			if state_x!=None and state_y!=None :
            				...
            				#points donnes en echelle 1:
           					self.position_perso.centerx=x_KTHN
           					self.position_perso.centery=y_KTHN
           					print(self.position_perso.centerx, self.position_perso.centery)
