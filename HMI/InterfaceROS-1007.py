...
def callbackGPSQuality(msg):
    ...
    rospy.loginfo("recu GPS string messages [%f, %f]" %(x, y))


SubsGPSQuality=rospy.Subscriber("/play_1499694649383989747", Odometry, callbackGPSQuality)
        ...
        while self.loop:
            ...
            if xS_KTH!=None and yS_KTH!=None and state_x!=None and state_y!=None and xS_Kista!=None and yS_Kista!=None  :
                ...
                if x_KTH>937 and x_KTH<1240 and y_KTH>286 and y_KTH<574:
                    ...
                    #print('ligne 549 position KTHN', x_KTHN, y_KTHN)
            ...
            if self.zoom==1 and state_x!=None and state_y!=None and self.map1=='KistaMap':
                    ...
                    self.position_arrow.centerx, self.position_arrow.centery=x_Kista, y_Kista
            ...
            if self.zoom==1 and state_x!=None and state_y!=None and self.map1=='KTHMap':
                    ...
                    self.position_arrow.centerx, self.position_arrow.centery=x_KTH,y_KTH
            ...
            if self.zoom==2 and state_x!=None and state_y!=None and self.map1=='KTHN':
            	...
            	if x_KTH>937 and x_KTH<1240 and y_KTH>286 and y_KTH<574:
                    ...
                    self.position_arrow.centerx=x_KTHN
                    self.position_arrow.centery=y_KTHN
            ...
            if self.zoom==2 and state_x!=None and state_y!=None and self.map1=='KTHS':
            	...
            	if x_KTH>999 and x_KTH<1238 and y_KTH>448 and y_KTH<757:
                    ...
                    self.position_arrow.centerx=x_KTHS
                    self.position_arrow.centery=y_KTHS
            ...
            if self.zoom==2 and state_x!=None and state_y!=None and self.map1=='KistaN':
            	...
            	if x_Kista>783 and x_Kista<1184 and y_Kista>156 and y_Kista<573:
                    ...
                    self.position_arrow.centerx=x_KistaN
                    self.position_arrow.centery=y_KistaN
            ...
            if self.zoom==2 and state_x!=None and state_y!=None and self.map1=='KistaS':
                if x_Kista<1227 and x_Kista>911 and y_Kista>305 and y_Kista<725:
                    ...
                    self.position_arrow.centerx=x_KistaS
                    self.position_arrow.centery=y_KistaS


            #LE CODE PEUT ETRE REDUIT VOIR VERSION 2
            #Affichage
            #print('ligne 619 Position perso :',self.position_perso.centerx, self.position_perso.centery, Click)
            #Kista Nord
            if self.map1=='KistaN':
                #KistaN=pygame.image.load('KistaN.png').convert()
                KistaN=pygame.transform.scale(pygame.image.load('KistaN.png').convert(),(1072,872))
            ...
            #KTH Sud
            #print('avant affichage KTHS', self.map)
            ...
            #print('ligne 705 Position perso :',self.position_perso.centerx, self.position_perso.centery, Click)

            #Affichage des points du scenario 1
            #print('self.scenario1', self.Scene1)
            if self.Scene1==True:
                print('ENTER')
                for i in range (len(Tableau1)):
                    x,y=Tableau1[i][0], Tableau1[i][1]
            ...
            #print('ligne 745',self.status, StockPosition[0][0]-StockPosition[1][0],StockPosition[0][1]-StockPosition[1][1])         
