...
''' For obstacle display '''
StockObstacle = ['False', 'False']
...
class Game:
    ...
    def update_textes(self):
        self.textes = [ ["Autonomous Driving with F1/10", ORANGE, self.small, 0, 50],
                        ...
                        ["GPS quality :", BLACK, self.small, -98, 280],
                        ["Maps :", BLACK, self.small, -145, 500],
                        ["OpenStreetMap ", BLACK, self.verysmall, 142, 790],
                        [str(date), BLACK, self.verysmall, 172, 801],
                        ["Obstacle detection :", BLACK, self.small, -44, 350],
                        [str(self.obt_detec), BLACK, self.small, 175, 350],
                        [str(self.VarMess), BLACK, self.small, 0, 420],
                        ]
    ...
    def create_button(self):
        ...
        self.waypointsStart_button = Button(self.fond, "  Send waypoints  ", MARRON2, self.small, -20, 580)
        self.waypointsReset_button=Button(self.fond,"  Reset waypoints  ", MARRON2, self.small, -16,650)
        self.Kista_button = Button(self.fond, "  Kista  ", BEIGE, self.small, 130, 500)
        self.KTH_button = Button(self.fond, "  KTH  ", BEIGE, self.small, 10, 500)
        ...
        #self.sensors_button = Button(self.fond, "  Sensors  ", BEIGE, self.small, -80, 700)
        #self.control_button = Button(self.fond, "  Control  ", BEIGE, self.small, 120, 700)
        #self.camera_button = Button(self.fond, "  Camera  ", BEIGE, self.small, -80, 750)
        #self.localisation_button = Button(self.fond, "Localisation", BEIGE, self.small, 120, 750)
    ...
    def infinite_loop(self):
        ...
        while self.loop :
            ...
            #self.localisation_button.display_button(self.fond)
            #self.camera_button.display_button(self.fond)
            #self.control_button.display_button(self.fond)
            #self.sensors_button.display_button(self.fond)
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    #self.localisation_button.update_button(self.fond, action = LaunchLocalisation)
                    #self.camera_button.update_button(self.fond, action = LaunchCamera)
                    #self.control_button.update_button(self.fond, action = LaunchControl)
                    #self.sensors_button.update_button(self.fond, action = LaunchSensors)
                ...
                if event.type == pygame.MOUSEBUTTONDOWN and event.button == 5 and event.pos[0] > 500 :
                    ...
                    if self.map1 == 'KTHE' or self.map1 == 'KTHW' :
                        ...
                        pygame.draw.line(KTHMap, BLACK, [1000-55, 840], [1000, 840], 2)
                        pygame.draw.line(KTHMap, BLACK, [1000-55, 840], [1000-55, 837], 2)
                        pygame.draw.line(KTHMap, BLACK,[1000, 840], [1000, 837], 2)
                        self.screen.blit(KTHMap, (500,0))
                        self.map1 = 'KTHMap'
                        ...
                        pygame.draw.polygon(KistaMap,(0,0,0), ((1000,810),(1008,810),(1008,840), (1012,840),(1012,810),(1020, 810), (1010,800)))
                        pygame.draw.line(KistaMap, BLACK, [1000-55, 840], [1000, 840], 2)
                        pygame.draw.line(KistaMap, BLACK, [1000-55, 840], [1000-55, 837], 2)
                        pygame.draw.line(KistaMap, BLACK,[1000, 840], [1000, 837], 2)
                        self.screen.blit(KistaMap, (500,0))
                        self.map1 = 'KistaMap'
            ...
            if self.map1 == 'KTHMap' :
                ...
                x, y = 980, 830
                pygame.draw.polygon(KTHMap, (0,0,0), ((950,830), (950+10,830), (950+10, 830 - 2), (6+950, 830 - 2), (950+6, 830 - 15), (4+950, 830 - 15), (950, 830 - 10), (950, 830 - 8), (950 + 4, 830 - 8), (950 + 4, 830 - 10), (950 + 4, 830 - 2), (950, 830 - 2)))
                pygame.draw.polygon(KTHMap, (0,0,0), ((962, 820),  (962, 820 + 6),  (962 + 2, 820 + 10),  (962 + 10, 820 + 10),  (962 + 12, 820 + 6),  (962 + 12, 820), (962 + 10, 820 - 4), (962 + 2, 820 - 4),
                 (962 + 4, 820 - 2), (962 + 2, 820), (962 + 2, 820 + 6), (962 + 4, 820 + 8), (962 + 8, 820 + 8), (962 + 10, 820 + 6), (962 + 10, 820),(962 + 8, 820 - 2), (962 + 2, 820 - 4)))
                pygame.draw.polygon(KTHMap, (0,0,0), ((x, y), (x, y -6), (x + 10, y - 6), (x + 10, y), (x + 8, y), (x + 8, y - 4), (x + 6, y), (x + 4, y), (x + 4, y - 4), (x + 2, y - 4), (x + 2, y)))
                pygame.draw.line(KTHMap, BLACK, [1000 - 55, 840], [1000, 840], 2)
                pygame.draw.line(KTHMap, BLACK, [1000 - 55, 840], [1000 - 55, 837], 2)
                pygame.draw.line(KTHMap, BLACK, [1000, 840], [1000, 837], 2)
                self.screen.blit(KTHMap, (500,0))
            ...
            if self.map1 == 'KistaMap' :
                ...
                x, y = 980, 830
                pygame.draw.polygon(KistaMap, (0,0,0), ((950,830), (950+10,830), (950+10, 830 - 2), (6+950, 830 - 2), (950+6, 830 - 15), (4+950, 830 - 15), (950, 830 - 10), (950, 830 - 8), (950 + 4, 830 - 8), (950 + 4, 830 - 10), (950 + 4, 830 - 2), (950, 830 - 2)))
                pygame.draw.polygon(KistaMap, (0,0,0), ((962, 820),  (962, 820 + 6),  (962 + 2, 820 + 10),  (962 + 10, 820 + 10),  (962 + 12, 820 + 6),  (962 + 12, 820), (962 + 10, 820 - 4), (962 + 2, 820 - 4),
                 (962 + 4, 820 - 2), (962 + 2, 820), (962 + 2, 820 + 6), (962 + 4, 820 + 8), (962 + 8, 820 + 8), (962 + 10, 820 + 6), (962 + 10, 820),(962 + 8, 820 - 2), (962 + 2, 820 - 4)))
                pygame.draw.polygon(KistaMap, (0,0,0), ((x, y), (x, y -6), (x + 10, y - 6), (x + 10, y), (x + 8, y), (x + 8, y - 4), (x + 6, y), (x + 4, y), (x + 4, y - 4), (x + 2, y - 4), (x + 2, y)))
                pygame.draw.line(KistaMap, BLACK, [1000 - 55, 840], [1000, 840], 2)
                pygame.draw.line(KistaMap, BLACK, [1000 - 55, 840], [1000 - 55, 837], 2)
                pygame.draw.line(KistaMap, BLACK, [1000, 840], [1000, 837], 2)
                self.screen.blit(KistaMap, (500,0))
            ...
            ''' Obstacle display '''
            variableObstacle += 1
            StockObstacle[0] = StockObstacle[1]
            StockObstacle[1] = Obstacle

            if StockObstacle[0] == 'False' and StockObstacle[1] == 'True':
                x_obs, y_obs = self.position_perso.centerx + 5, self.position_perso.centery
                pygame.draw.circle(self.screen, BLACK, (x_obs, y_obs), 5, 0)
...
def LaunchCamera():
    os.system("roslaunch control1 Camera.launch")
    print("launch camera")

def LaunchSensors():
    os.system("roslaunch control1 Sensors.launch")
    print("launch Sensors")

def LaunchControl():
    os.system("roslaunch control1 PID.launch")
    print("launch control")

def LaunchLocalisation():
    os.system("roslaunch control1 Localization.launch")
    print("launch localisation")
