#! /usr/bin/env python
# Reads GPS data from Emlid Reach and publishes:
# A standard NavSat message
# A custom gps_reach message (NMEA standard - see http://www.rtklib.com/prog/manual_2.4.2.pdf page 102)
